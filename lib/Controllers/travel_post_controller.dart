...
class TravelPostController extends GetxController {
  ...
  Future<void> createTravelPost() async {
    ...
    final response = await http.post(
      Uri.parse("$baseUrl/post_travels.php"),
      headers: {
      ...
      "travel_time": dateTimeController.formatTimeOfDay(dateTimeController.selectedTime.value),
    ...
    if (response.statusCode == 200) {
      ...
      if (data["success"] == true) {
        await storage.write(key: "travel_id", value: data["travel_id"].toString());
