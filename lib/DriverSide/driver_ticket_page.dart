...
class DriverTicketPage extends StatelessWidget {
  const DriverTicketPage({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text('Requeted Hikers', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16),),
                    )
                  ],
                )),
            Expanded(
